...
{
    public class municipal_financial_profile : base_record_financial_data
    {
        [Key]
        public Guid municipal_financial_profile_id { get; set; }
        
        public DateTime? talakayan_date_start { get; set; }
        public DateTime? talakayan_date_end { get; set; }

        public decimal? mlgu_locally_sourced_revenues { get; set; }
    ...
    public class base_record_financial_data
    {
        [JsonIgnore]
