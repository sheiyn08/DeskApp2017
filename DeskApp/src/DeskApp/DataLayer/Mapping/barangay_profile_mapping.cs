...
{
    public class brgy_profile_mapping
    {
        ...
        public string baragay_additiondetails { get; set; }
        ...
        #region dropdown
        //public IEnumerable<lib_region> lib_regions { get; set; }
        //public IEnumerable<lib_province> lib_provinces { get; set; }
        //public IEnumerable<lib_city> lib_cities { get; set; }
        //public IEnumerable<lib_brgy> lib_brgys { get; set; }

        //public IEnumerable<lib_fund_source> lib_fund_sources { get; set; }

        //public IEnumerable<lib_cycle> lib_cycles { get; set; }
